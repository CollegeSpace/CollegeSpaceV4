...
<title>ACADEMICA, Courses-3</title>
  ...
  <div id="wrapper">
    ...
    <main class="main-content">
      <div class="container">
        ...
        <div class="row">
          <div class="col-xs-12">
            <article class="post post_mod-i clearfix">
              <div class="entry-media">
                <div class="entry-thumbnail"> <a href="javascript:void(0);" ><img class="img-responsive" src="assets/media/posts/250x250/7.jpg" width="250" height="250" alt="Foto"/></a> </div>
              ...
              <div class="entry-main">
                ...
                <div class="entry-meta decor decor_mod-a"> <span class="entry-autor"> <span>By </span> <a class="post-link" href="javascript:void(0);">University of LIMS</a> </span> </div>
                <div class="entry-content">
                  <p>Fusce eleifend donec sapien sed phase lusa pellentesque lacus vamus lorem arcu semper duiac rasorn are arcu vamus nda leo. Etiam ind arcu morbi justo mauris tempus pharetra interdum congue semper purus lorem ipsum dolor sit amet sed consectetur adipisicing elit sad.</p>
                </div>
                ...
                <div class="post-label post-label_mod-a"> <span class="post-label__text">verified</span>
                  <div class="post-label__inner"><span class="icon stroke icon-Like"></span></div>
                </div>
              </div>
            </article>
            <!-- end post -->
            ...
            <article class="post post_mod-i clearfix">
              ...
              <div class="entry-main">
                <h3 class="entry-title ui-title-inner"><a href="javascript:void(0);"><span class="post-action">FREE! </span>CHILDHOOD IN THE DIGITAL AGE</a></h3>
                <ul class="rating">
                  <li><i class="icon fa fa-star"></i></li>
                  <li><i class="icon fa fa-star"></i></li>
                  <li><i class="icon fa fa-star"></i></li>
                ...
                <div class="post-label post-label_mod-b"> <span class="post-label__text">NEW</span>
                  <div class="post-label__inner"><span class="icon stroke icon-Flag"></span></div>
                </div>
              </div>
            </article>
            <!-- end post -->
            ...
            <article class="post post_mod-i clearfix">
              ...
              <div class="entry-main">
                <h3 class="entry-title ui-title-inner"><a href="javascript:void(0);">introduction to computer sciences</a></h3>
                <ul class="rating">
                  <li><i class="icon fa fa-star"></i></li>
                  <li><i class="icon fa fa-star"></i></li>
                  <li><i class="icon fa fa-star"></i></li>
            ...
            <article class="post post_mod-i clearfix">
              <div class="entry-media">
                <div class="entry-thumbnail"> <a href="javascript:void(0);" ><img class="img-responsive" src="assets/media/posts/250x250/9.jpg" width="250" height="250" alt="Foto"/></a> </div>
                <div class="entry-hover"> <a href="javascript:void(0);" class="post-btn btn btn-primary btn-effect">READ MORE</a> </div>
              </div>
              <div class="entry-main">
                <h3 class="entry-title ui-title-inner"><a href="javascript:void(0);"><span class="post-action">FREE! </span>clinical supervision with confidence</a></h3>
                <ul class="rating">
                  <li><i class="icon fa fa-star"></i></li>
                  <li><i class="icon fa fa-star"></i></li>
                  <li><i class="icon fa fa-star"></i></li>
                ...
                <div class="post-label post-label_mod-c"> <span class="post-label__text">HOT</span>
                  <div class="post-label__inner"><span class="icon stroke icon-Pen"></span></div>
                </div>
              </div>
            </article>
            <!-- end post -->
            ...
            <article class="post post_mod-i clearfix">
              <div class="entry-media">
                <div class="entry-thumbnail"> <a href="javascript:void(0);" ><img class="img-responsive" src="assets/media/posts/250x250/8.jpg" width="250" height="250" alt="Foto"/></a> </div>
                <div class="entry-hover"> <a href="javascript:void(0);" class="post-btn btn btn-primary btn-effect">READ MORE</a> </div>
              </div>
              <div class="entry-main">
                <h3 class="entry-title ui-title-inner"><a href="javascript:void(0);">ways of smarter learning</a></h3>
                <ul class="rating">
                  <li><i class="icon fa fa-star"></i></li>
                  <li><i class="icon fa fa-star"></i></li>
                  <li><i class="icon fa fa-star"></i></li>
