...
<div id="spacing">
  ...
  <div class="main-content">
    <div id="sliderpro1" class="slider-pro main-slider">
      <div class="sp-slides">
        <div class="sp-slide">
          <img class="sp-image" src="assets/img/1st.jpg" data-src="assets/img/1st.jpg" alt="img"/>
       ...
       <!-- <div class="main-slider__inner text-center">
        ...
        <div class="sp-slide"> <img class="sp-image" src="assets/img/2nd.jpg" data-src="assets/img/2nd.jpg" alt="img"/>
        ...
        <div class="sp-slide"> <img class="sp-image" src="assets/img/3rd.jpg" data-src="assets/img/3rd.jpg" alt="img"/>
          <div class="item-wrap sp-layer  sp-padding" data-horizontal="700" data-vertical="1" data-show-transition="left" data-hide-transition="up" data-show-delay="400" data-hide-delay="200">
       <!-- <div class="main-slider__inner text-center">
        <div class="main-slider__title" >BEST ONLINE LEARNING</div>
        <div class="main-slider__subtitle ">THE EASIER WAY</div>
        ...
        <div class="sp-slide"> <img class="sp-image" src="assets/img/4th.jpg" data-src="assets/img/4th.jpg" alt="img"/>
          <div class="item-wrap sp-layer  sp-padding" data-horizontal="700" data-vertical="1" data-show-transition="left" data-hide-transition="up" data-show-delay="400" data-hide-delay="200">
       <!-- <div class="main-slider__inner text-center">
        <div class="main-slider__title" >BEST ONLINE LEARNING</div>
        <div class="main-slider__subtitle ">THE EASIER WAY</div>
