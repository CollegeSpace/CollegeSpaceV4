        ...
        <div class="container">
            ...
            <hr>
                ...
                <div class="portfolio-items" style="z-index:1;">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 portfolio-item leadership alum">
                        <div class="portfolio-wrapper">
                          <div class="staff">
                                        ...
                                        <div class="staff__inner staff__inner_mod-a">
                                           ...
                                           <h2>Sofia Grace</h2>
                                            ...
                                            <ul class="social-links list-unstyled">
                                             ...
                                             var span = document.getElementsByClassName("1")[0];
                                         ...
                                         <div id="myModal2" class="modal" style="z-index:100;">
                                           ...
                                           <h2>Sofia Grace</h2>
                                            ...
                                            <ul class="social-links list-unstyled">
                                             ...
                                             // Get the element that closes the modal
                                             var span = document.getElementsByClassName("2")[0];
                                         ...
                                         <div id="myModal3" class="modal">
                                           ...
                                           <h2>Sofia Grace</h2>
                                            ...
                                            <ul class="social-links list-unstyled">
                                             ...
                                             // Get the element that closes the modal
                                             var span = document.getElementsByClassName("3")[0];
                                         ...
                                         <div id="myModal4" class="modal">
                                           ...
                                           <h2>Sofia Grace</h2>
                                            ...
                                            <ul class="social-links list-unstyled">
                                             ...
                                             // Get the element that closes the modal
                                             var span = document.getElementsByClassName("4")[0];
