       ...
       <div id="portfolio">
        <div class="container">
            ...
            <div class="posts-wrap" >
                    ...
                    <li><a id="writer" class="btn btn-default" href="#" data-filter=".contentw">Content Writers</a></li>
                ...
                <div class="portfolio-items" style="z-index:1;">
                     <div class="col-xs-12 col-sm-12 col-md-3 portfolio-item leadership">  
      ...
      <div id="myModal12" class="modal" style="z-index:100;">
                                        <!-- Modal content -->
                                           ...
                                           <h2> Sahil Gulati </h2>
                                            ...
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/nsit.sahil "></a></li>
                                                <li><a class="icon fa fa-twitter" href=" https://twitter.com/nsitsahil "></a></li>
                                                <li><a class="icon fa fa-google-plus" href=" https://plus.google.com/+SAHILGULATI1/ "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://www.linkedin.com/in/nsitsahil "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal47" class="modal" style="z-index:100;">
                                           ...
                                           <h2>Tushar Gupta</h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href="https://www.facebook.com/tushar.gupta.9828"></a></li>
                                                <li><a class="icon fa fa-linkedin" href="https://www.linkedin.com/in/tushar-gupta-a9721611a"></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal46" class="modal" style="z-index:100;">
                      ...
                      <div id="myModal21" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Shwetank Pandey </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/shwetank95 "></a></li>
                                                <li><a class="icon fa fa-twitter" href=" https://twitter.com/shw3tank "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://in.linkedin.com/in/shwetank-pandey-079609a2 "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal74" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Aman Mahajan </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" http://facebook.com/amanmj95 "></a></li>
                                                <li><a class="icon fa fa-twitter" href=" https://twitter.com/amanmj95 "></a></li>
                                                <li><a class="icon fa fa-google-plus" href=" https://plus.google.com/u/0/109476220738135555887 "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://in.linkedin.com/in/amanmj "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal6" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Gautam Kumar Sharma </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/gautam.k.sharma.14 "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
              ...
              <div id="myModal51" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Arpit Bajaj </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/arpit.bajaj "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://www.linkedin.com/in/arpit-bajaj "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
...
<div id="myModal41" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Abhisar Garg </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" facebook.com/abhisar95 "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal76" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Ayush Garg </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href="https://www.facebook.com/ayush.garg.940"></a></li>
                                                <li><a class="icon fa fa-linkedin" href="https://in.linkedin.com/in/ayushgarg1804"></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal4" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Deepika Naryani </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/deepika.naryani1 "></a></li>
                                                <li><a class="icon fa fa-google-plus" href=" https://plus.google.com/u/0/+DeepikaNaryani "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" www.linkedin.com/in/deepika-naryani "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal28" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Jasdeep Singh </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/jasdeepsingh27 "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal62" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Isha Gupta </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/profile.php?id=100005860599217 "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://www.linkedin.com/in/isha-gupta-46a92684?trk=hp-identity-name "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal16" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Jaswin Kaur </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/jaswin.smile "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://www.linkedin.com/in/jaswin-kaur-276557102?trk=nav_responsive_tab_profile "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal17" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Harsh Vardhan </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/harshv01.12 "></a></li>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal32" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Prabha Pant </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/prabhapant08 "></a></li>
                                                <li><a class="icon fa fa-twitter" href=" None "></a></li>
                                                <li><a class="icon fa fa-google-plus" href=" None "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://www.linkedin.com/in/prabha-pant-7553264a?trk=nav_responsive_tab_profile_pic "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal66" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Aditi Sharma </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/profile.php?id=100002345234664 "></a></li>
                                                <li><a class="icon fa fa-twitter" href=" https://twitter.com/aditi369sharma_ "></a></li>
                                                <li><a class="icon fa fa-google-plus" href=" https://plus.google.com/u/0/111376973777297532353 "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://in.linkedin.com/in/aditi-sharma-6bb584102 "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal45" class="modal" style="z-index:100;">
                                           ...
                                           <h2> MOHIT SINGH </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/profile.php?id=100004691267371 "></a></li>
                                                <li><a class="icon fa fa-twitter" href=" https://twitter.com/Mohit_singh27 "></a></li>
                                                <li><a class="icon fa fa-google-plus" href=" https://plus.google.com/109516313167629254542 "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://www.linkedin.com/in/mohit-singh-a8aaa9aa?trk=nav_responsive_tab_profile "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal8" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Arko Gupta </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/arkogupta "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://www.linkedin.com/in/arko-gupta-3b309429?trk=nav_responsive_tab_profile "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal35" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Shreshth Sharma </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" king.shreshth "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal22" class="modal" style="z-index:100;">
                                           ...
                                           <h2> KANISHKA GOSAIN </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" kanishkagosain05@gmail.com "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal10" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Mayank Badola </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/mbad0la "></a></li>
                                                <li><a class="icon fa fa-twitter" href=" https://www.twitter.com/mbad0la "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://www.linkedin.com/mbad0la "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal27" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Aman Priyadarshi </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/aman.eureka "></a></li>
                                                <li><a class="icon fa fa-twitter" href=" https://twitter.com/amaneureka "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://www.linkedin.com/in/amaneureka "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal23" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Prerna Kakkar </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/pkakkar95 "></a></li>
                                                <li><a class="icon fa fa-google-plus" href=" https://plus.google.com/u/0/116228375604457634198 "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://in.linkedin.com/in/prerna-kakkar-b07022112 "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal3" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Anshul Khanna </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/anshul.khanna.39545 "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal30" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Jyoti </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" http://facebook.com/jyoti.yadav.7731/ "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal11" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Tarasha Khurana </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/tarasha.khurana "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://in.linkedin.com/in/tarasha-khurana-9661a887 "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal49" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Aastha </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/profile.php?id=100000054255395&fref=ts "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal18" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Nilay Shrivastava </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/nilay.shrivastava.14?fref=ts "></a></li>
                                                <li><a class="icon fa fa-twitter" href=" https://twitter.com/nilayshri "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal44" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Naman Malhotra </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/naman03malhotra "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://www.linkedin.com/in/naman03malhotra "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal34" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Aprajita Singh </h2>
                                             ...
                                             <div class="modal-body">
                                             <p><b> CONTENT COLLECTOR/WEB DEVELOPER </b></p>
                                             <p> I get high on books and meditate on codes. </p>
                                             </div>
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://web.facebook.com/aprajita.singh.165 "></a></li>
                                                <li><a class="icon fa fa-google-plus" href=" https://plus.google.com/u/0/100067273743849621590 "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal36" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Pranshu Agarwal  </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://facebook.com/agarwal.pranshu "></a></li>
                                                <li><a class="icon fa fa-twitter" href=" @Pranshu51787737 "></a></li>
                                                <li><a class="icon fa fa-google-plus" href=" pranshu.agarwal1996@gmail.com "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal43" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Priyanka </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/priyanka1801 "></a></li>
                                                <li><a class="icon fa fa-twitter" href=" https://twitter.com/mepriyanka97 "></a></li>
                                                <li><a class="icon fa fa-google-plus" href=" https://plus.google.com/118178213707216495243 "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://in.linkedin.com/in/priyanka-mohan-557039112 "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal19" class="modal" style="z-index:100;">
                                           ...
                                           <h2> HARSHPREET SINGH </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/singh.harshpreet07 "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal24" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Shubaangi Bisht </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-linkedin" href=" www.linkedin.com/in/shubaangi-bisht-74ba00112 "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal37" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Jeevesh Narang </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/jeevesh.narang "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal39" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Parth Mittal </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://m.facebook.com/parth.mittal.125?ref=bookmarks "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://www.linkedin.com/in/parth-mittal-8b921311a "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal40" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Avni Arora </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/avni.arora.33 "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://www.linkedin.com/profile/preview?locale=en_US&trk=prof-0-sb-preview-primary-button "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal55" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Sahil Dua </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/profile.php?id=100001659260195&fref=ts "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal59" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Manraj Singh </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/profile.php?id=715740396&fref=ts "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal56" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Divjot Singh </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/profile.php?id=680289259&fref=ts "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal75" class="modal" style="z-index:100;">
                                           ...
                                           <div class="img"></div><img class="img-responsive" src="assets/CS pics/FULL/abhinav.jpg" height="100" width="100" alt="foto" align="middle">
                     ...
                     <div id="myModal58" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Siddharth Jain </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/profile.php?id=100002552255153&fref=ts "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal53" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Rahul Gandhi </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://m.facebook.com/rahulgandhi93?ref=bookmarks "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal15" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Ayush Maiti </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/ayush.maiti "></a></li>
                                                <li><a class="icon fa fa-google-plus" href=" https://plus.google.com/u/0/+AyushMaiti "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://www.linkedin.com/in/ayushmaitii?trk=nav_responsive_tab_profile_pic "></a></li>
                                            </ul>
                                             </div>
                                             </div>
                     ...
                     <div id="myModal52" class="modal" style="z-index:100;">
                                           ...
                                           <h2> Vishal Vedwal </h2>
                                             ...
                                             <div class="modal-footer">
                                            <ul class="social-links list-unstyled">
                                                <li><a class="icon fa fa-facebook" href=" https://www.facebook.com/iamvishalvedwal "></a></li>
                                                <li><a class="icon fa fa-linkedin" href=" https://in.linkedin.com/in/vishalvedwal "></a></li>
                                            </ul>
                                             </div>
                                             </div>
